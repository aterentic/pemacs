...
(setq org-tag-faces
      `(("alarm"    . (:background ,reaktor/magenta :foreground ,reaktor/bg))
        ...
        ("home"     . (:background ,reaktor/chip    :foreground ,reaktor/red))
	...
	'(("d" "Daily"
	   ((agenda "" ((org-agenda-span 'day)
	    ...
	    (agenda "" ((org-agenda-span 'day)
			(org-agenda-skip-function
			 '(let ((tags (org-get-tags)))
			    (unless (or (member "home" tags)
					(member "project" tags))
			      (org-end-of-subtree t))))
			(org-agenda-overriding-header "Projects & Home")))))
	  ("ct" "TODO" tags-todo "TODO=\"TODO\"-job-supplies-reading-shopping")
	  ("ch" "Home" tags-todo "TODO=\"TODO\"+home")
	  ("cr" "Reading" tags-todo "TODO=\"TODO\"+reading")
	  ("s" . "Shopping & Supplies")
	  ("sb" "Shopping" tags-todo "TODO=\"TODO\"+shopping-review")
	  ("sr" "Shopping review" tags-todo "TODO=\"TODO\"+shopping+review")
	  ("ss" "Supplies" tags-todo "TODO=\"NEED\"|TODO=\"TODO\"+supplies")
	  ("t" . "Travel")
